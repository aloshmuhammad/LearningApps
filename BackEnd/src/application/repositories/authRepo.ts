...
const messageSave=async(message:{isFrom:string,content:string,reciever:string,commonId:string,from:string,time:string})=>await repositories.messageSave(message)
