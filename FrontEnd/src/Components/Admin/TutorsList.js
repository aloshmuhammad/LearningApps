...
const confirmAction= () => {
  ...
  instance.post('/admin/tutor-block',body).then((response)=>{
...
<Modal open={showModal} onClose={closeModal} aria-labelledby="confirm-modal-title">
