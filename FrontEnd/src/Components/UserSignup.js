        ...
        .then((response) => {
          if (response?.data?.userGoogle?.status == false) {
            ...
            localStorage.setItem(
              "UserInfo",
              JSON.stringify(response?.data?.userGoogle?.validUser)
            );
            localStorage.setItem(
              "userToken",
              response?.data?.userGoogle?.token
            );
      ...
      instance
        ...
        .then((response) => {
          ...
          if (response?.data?.userToken?.status == false) {
            ...
            localStorage.setItem(
              "UserInfo",
              JSON.stringify(response?.data?.userToken?.validUser)
            );
