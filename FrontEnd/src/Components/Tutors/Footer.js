        ...
        <Box sx={{ display: "flex", justifyContent: "space-between", mb: 4 }}>
          <Box sx={{ flexBasis: "40%" }}>
            ...
            <Typography variant="body1" sx={{ color: "black" }}>
              Web-based platform that provides a streamlined and efficient way
              for teachers to manage their online classes. The platform is
              designed to simplify communication and collaboration between
              teachers and students, and to make it easy for students to access
        ...
        <Box>
          <Box sx={{ maxWidth: "lg", mx: "auto" }}>
            <Typography variant="body2" sx={{ color: "black" }}>
              Alosh Muhammad. All rights reserved
            </Typography>
          </Box>
        </Box>
      </Box>
